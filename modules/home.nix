...
in
{
  ...
  programs.zsh = {
    ...
    sessionVariables = {
      ...
      KERL_CONFIGURE_OPTIONS="--enable-dynamic-ssl-lib --with-ssl=${pkgs.openssl} --enable-hipe --enable-shared-zlib --enable-smp-support --enable-threads --enable-wx --disable-debug --without-javac";
    };
